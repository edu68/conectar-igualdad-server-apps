...
<div id="menu" align="center">
    ...
    <li><span></span><a href="#">Ayuda</a>
      <ul>
        <li><span></span><?php echo link_to("Manual", "http://".sfContext::getInstance()->getRequest()->getHost().sfContext::getInstance()->getRequest()->getRelativeUrlRoot()."/manual/", 'target=_blank')?></li>
